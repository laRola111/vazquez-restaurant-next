...
export const dictionary = {
  ...
  footer: {
    ...
    quickLinks: 'Quick Links', // <-- ADDED
    contactInfo: 'Contact Info', // <-- ADDED
    followUs: 'Follow Us', // <-- ADDED
  },
 hero: {
    title: "Welcome to Vázquez Restaurant #3", // <-- UPDATED (with accent per image)
    subtitle: "Since 2001, serving traditional dishes made with love. Tacos, enchiladas, menudo & more.", // <-- UPDATED (removed moles/grilled, added menudo)
    button: "View Full Menu",
    imageAlt: "Mexican restaurant serving traditional food", // <-- UPDATED
  },
  about: { // <-- NEW SECTION
    since: "Since 2001",
    mainText: "Everything done with love",
    description: "Explore our selection of tacos, enchiladas, gorditas, menudo and more, each crafted to bring a taste of authentic Mexico to your table, and inspire a sense of joy and connection.", // <-- Adjusted text
    imageAlt: "Collage of Mexican dishes", // Alt for the decorative image
  },
  menu: {
    // --- Breakfast ---
    breakfastTacos: {
     ...
     breakfastPlates: {
      ...
      items: [
        { name: 'CLASSIC BREAKFAST', description: 'Two fresh eggs (any style) with your choice of: ham, bacon, sausage or chorizo, served with beans and potatoes.', price: 12.00 },
        { name: 'HUEVOS RANCHEROS', description: 'Two fresh eggs (any style) topped with ranchera sauce, with your choice of bacon, sausage or ham, served with potatoes and beans.', price: 12.00 },
        { name: 'HUEVOS DIVORCIADOS', description: 'Two fresh eggs (any style), one egg topped with green sauce and one with red sauce served with beans and potatoes.', price: 15.00 },
        { name: 'NOPALITOS', description: 'Fresh nopalitos mix with two eggs served with beans and potatoes.', price: 13.00 },
        { name: 'FAJITA AND EGG', description: 'Two fresh eggs (any style) with fajita served with beans and potatoes.', price: 17.00 },
        { name: 'MIGAS RANCHERAS', description: 'Two fresh eggs scrambles with corn chips freshly diced jalapeños, onions and tomatoes topped with ranchera sauce and cheese, served with beans and potatoes.', price: 13.00 },
        { name: 'MIGAS', description: 'Two fresh eggs scrambled with corn chips diced jalapeños, onions and tomatoes served with beans and potatoes.', price: 12.00 },
        { name: 'CHILAQUILES', description: 'Home made tortilla chips and salsa, topped with queso fresco served with two eggs your choice of beans or potatoes.', price: 13.00, addBarbacoa: '$6 extra', addFajita: '$7 extra' },
    ...
    gorditasALaCarta: {
     ...
     enchiladasPlates: {
        ...
        items: [
            { name: 'ENCHILADAS (BEEF, CHEESE OR CHICKEN)', description: 'Two enchiladas, served with rice, beans.', price: 13.00 },
    ...
    lunchDinnerPlates: {
        ...
        items: [
            { name: 'MEXICAN STEAK', description: 'Tender strips of steak, grilled with onions, serranos peppers and tomatoes, served with rice, beans, guacamole salad and two tortillas.', price: 18.00 },
            ...
            { name: 'AL PASTOR', description: 'Marinated pork, served with rice beans, cilantro, onions and two tortillas.', price: 16.00 },
            ...
            { name: 'MI TIERRA BURRITO', description: 'A big flour tortilla filled with spicy adobado (pork) and rice topped with adobado sauce, white cheese, sour cream, avocado slices served with rice and beans.', price: 15.00 },
            ...
            { name: 'CRISPY TACO PLATE (3)', description: '3 crispy tacos with lettuce Tomatoes, cheese, served with rice and beans.', price: 13.00 },
            ...
            { name: 'CALDO DE RES', description: 'Beef soup with vegetables, served with rice and side of fresh jalapeños, onions and lime.', priceLg: 16.00, priceSm: 14.00, sizeNote: '(Lg 32oz) (Sm 20oz.)' },
        ]
    },
    // --- Appetizers & Others ---
    appetizers: {
        ...
        items: [
            ...
            { name: 'FAJITA NACHOS (8)', description: 'Your choice of beef or chicken topped with beans and cheese, served with sour cream, guacamole jalapeño on the side.', price: 15.00 },
    ...
    soupsAndMore: {
        ...
        items: [
            { name: 'MENUDO (THE HANGOVER CURE)', description: 'Homemade beef tripe stew with hominy and your side jalapeño, onions, lime and two tortillas.', priceLg: 16.00, priceSm: 13.00, sizeNote: 'LARGE 32oz / SMALL 20 oz' },
  ...
  // ... (we will add more general page sections here)
};